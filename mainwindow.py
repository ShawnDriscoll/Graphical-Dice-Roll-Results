...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.quitButton.setGeometry(QtCore.QRect(300, 490, 75, 23))
        self.quitButton.setObjectName("quitButton")
        self.rollBrowser = QtWidgets.QTextBrowser(self.centralwidget)
        self.rollBrowser.setGeometry(QtCore.QRect(180, 550, 151, 41))
        self.rollBrowser.setObjectName("rollBrowser")
        self.rollInput = QtWidgets.QLineEdit(self.centralwidget)
        self.rollInput.setGeometry(QtCore.QRect(100, 570, 61, 21))
        font = QtGui.QFont()
        ...
        self.diceinputLabel.setGeometry(QtCore.QRect(100, 550, 61, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Graphical Dice Roll 0.1.0 (Beta)"))

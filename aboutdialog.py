...
class Ui_aboutDialog(object):
    ...
    def retranslateUi(self, aboutDialog):
        ...
        self.textLabel.setText(_translate("aboutDialog", "<html><head/><body><p align=\"center\"><br/><span style=\" font-size:10pt;\">Graphical Dice Roll</span></p><p align=\"center\"><span style=\" font-size:10pt;\">by </span></p><p align=\"center\"><span style=\" font-size:10pt;\">Shawn Driscoll</span></p></body></html>"))
